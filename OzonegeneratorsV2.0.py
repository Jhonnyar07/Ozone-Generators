    ...
    if calcule == True:
        ...
        if Pr>2 and Pr<=12:
            ...
            with col13:
                ...
                DSP520 = pd.DataFrame({
                'Caudal Oxigeno (l/min)': [1,2,3,4,5,6,7,8,9],
                'Concentración O3 (gr/m3)': [75,69,67,62,58,48,43,40,37],
                'Producción O3 (g/h)': [4.5,8.28,12.06,14.88,17.4,17.28,18.06,19.2,19.98]
                })
